...
import com.techspinsolutions.vascoservices.adapter.couponsAdapter;
...
public class CouponsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        setAppbarText("Select Coupon Code");
        MainActivity.back_btn.setOnClickListener(v -> MainActivity.loadFragment(new HomeFragment()));

        RecyclerView recyclerView = view.findViewById(R.id.rv_coupons);
