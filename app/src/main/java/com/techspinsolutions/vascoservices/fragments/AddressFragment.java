...
import com.techspinsolutions.vascoservices.adapter.AddressAdapter;
...
public class AddressFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        setAppbarText("Enter Address");
        MainActivity.back_btn.setOnClickListener(v -> MainActivity.loadFragment(new HomeFragment()));

        RecyclerView recyclerView = view.findViewById(R.id.rv_address);
