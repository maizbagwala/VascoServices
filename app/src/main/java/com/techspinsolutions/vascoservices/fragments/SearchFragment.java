...
import com.techspinsolutions.vascoservices.adapter.SearchAdapter;
...
public class SearchFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        MainActivity.setAppbarWithBack(0);
        MainActivity.setBottomSelected("");
        view.findViewById(R.id.search_back).setOnClickListener(v -> MainActivity.loadFragment(new HomeFragment()));
